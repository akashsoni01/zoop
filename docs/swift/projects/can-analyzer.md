# Project: CAN Analyzer

Build **TWAI sniffer** on **ESP32-S3** using Embedded Swift.
...
| SN65HVD230 transceiver | 1 | See [sensors/](../sensors/README.md) |
| CAN bus tap | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
