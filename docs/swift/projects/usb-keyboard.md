...
Build **HID keyboard** on **ESP32-S3** using Embedded Swift.
...
| ESP32-S3 native USB | 1 | See [sensors/](../sensors/README.md) |
| Keys/matrix | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
