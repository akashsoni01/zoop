...
Build **ADC + BLE reporting** on **ESP32-S3** using Embedded Swift.
...
| Voltage divider | 1 | See [sensors/](../sensors/README.md) |
| 18650 cell | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
