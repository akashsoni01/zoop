...
Build **LoRa/Modbus to MQTT** on **ESP32-S3** using Embedded Swift.
...
| LoRa module (SPI) | 1 | See [sensors/](../sensors/README.md) |
| RS-485 transceiver | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
