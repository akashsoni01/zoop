...
Build **Multi-sensor dashboard** on **ESP32-S3** using Embedded Swift.
...
| BME280 + SGP30 | 1 | See [sensors/](../sensors/README.md) |
| OLED | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
