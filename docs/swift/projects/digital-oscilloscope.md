# Project: Digital Oscilloscope

Build **ADC streaming** on **ESP32-S3** using Embedded Swift.
...
| ESP32-S3 ADC | 1 | See [sensors/](../sensors/README.md) |
| Probe input | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
