...
Build **Cloud telemetry** on **ESP32-S3** using Embedded Swift.
...
| ESP32-S3 | 1 | See [sensors/](../sensors/README.md) |
| Sensor of choice | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
