...
Build **NMEA + logging** on **ESP32-S3** using Embedded Swift.
...
| NEO-6M GPS | 1 | See [sensors/](../sensors/README.md) |
| Optional SD | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
