...
Build **MQTT + provisioning** on **ESP32-S3** using Embedded Swift.
...
| Relay module | 1 | See [sensors/](../sensors/README.md) |
| Button | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
