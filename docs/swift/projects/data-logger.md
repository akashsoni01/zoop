...
Build **SD + RTC logging** on **ESP32-S3** using Embedded Swift.
...
| MicroSD module (SPI) | 1 | See [sensors/](../sensors/README.md) |
| DS3231 RTC | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
