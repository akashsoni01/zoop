...
Build **Input timing** on **ESP32-S3** using Embedded Swift.
...
| Signal input | 1 | See [sensors/](../sensors/README.md) |
| Optional prescaler | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
