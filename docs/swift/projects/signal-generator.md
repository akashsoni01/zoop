...
Build **DAC/PWM output** on **ESP32-S3** using Embedded Swift.
...
| ESP32-S3 DAC/PWM | 1 | See [sensors/](../sensors/README.md) |
| Scope/speaker | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
