...
Build **Two-motor platform** on **ESP32-S3** using Embedded Swift.
...
| 2× motor driver | 1 | See [sensors/](../sensors/README.md) |
| MPU6050 IMU | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
