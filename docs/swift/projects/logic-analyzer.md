...
Build **GPIO capture** on **ESP32-S3** using Embedded Swift.
...
| 8× GPIO inputs | 1 | See [sensors/](../sensors/README.md) |
| Target signals | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
