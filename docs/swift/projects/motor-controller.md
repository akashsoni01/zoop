...
Build **PID speed control** on **ESP32-S3** using Embedded Swift.
...
| L298N H-bridge | 1 | See [sensors/](../sensors/README.md) |
| DC motor + encoder | 1 | See [displays/](../displays/README.md) if applicable |
| Breadboard + wires | 1 | |
