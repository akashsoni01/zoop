# Example: Character LCD

**Goal:** HD44780 parallel — hands-on Embedded Swift.
...
```swift
struct HD44780 {
    var dataPins: [GPIO.Output<...>]
    var rs, en: GPIO.Output<...>
    mutating func writeCommand(_ cmd: UInt8) { /* nibble mode */ }
}
```

### Ownership / ARC Notes

- Parallel GPIO — 6+ pins exclusively owned.
