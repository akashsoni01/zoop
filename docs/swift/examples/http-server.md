...
**Goal:** Embedded web UI — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/http.md](../communication/http.md) if applicable.

**Protocol:** [communication/http.md](../communication/http.md)
...
```swift
struct WebServer {
    mutating func route(_ path: String, handler: @escaping () -> Response) {
...
- Handlers: `[weak var]` or struct-based routing table to avoid retain cycles.
