...
**Goal:** H-bridge DC — hands-on Embedded Swift.
...
```swift
struct HBridge {
    var in1, in2: GPIO.Output<...>
    var pwm: LEDC.PWM
    mutating func forward(speed: Float) { /* ... */ }
}
```

### Ownership / ARC Notes

- Never create retain cycles between motor controller class and callbacks — use structs.
