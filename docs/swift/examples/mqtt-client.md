...
**Goal:** Pub/sub telemetry — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/mqtt.md](../communication/mqtt.md) if applicable.

**Protocol:** [communication/mqtt.md](../communication/mqtt.md)
...
struct MqttPublisher {
    ...
    mutating func publish(topic: String, payload: [UInt8]) throws {
        try client.publish(topic: topic, payload: payload, qos: .atLeastOnce)
    }
}
```
...
- Payload as `[UInt8]` stack buffer preferred over `String` in hot path.
