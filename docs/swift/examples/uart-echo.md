...
**Goal:** Serial console — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/uart-usart.md](../communication/uart-usart.md) if applicable.

**Protocol:** [communication/uart-usart.md](../communication/uart-usart.md)
...
- Echo loop owns UART — single owner pattern.
