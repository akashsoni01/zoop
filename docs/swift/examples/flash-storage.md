# Example: Flash Storage

**Goal:** Raw partitions — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/14-dma.md](../14-dma.md) if applicable.

**Protocol:** [communication/14-dma.md](../14-dma.md)
...
```swift
let part = FlashPartition(name: "storage")
try part.erase(offset: 0, length: 4096)
try part.write(offset: 0, data: buffer)
```

### Ownership / ARC Notes

- Align writes to sector size — buffer must stay alive during write.
