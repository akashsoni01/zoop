...
**Goal:** LED dimming, servo — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/11-pwm.md](../11-pwm.md) if applicable.

**Protocol:** [communication/11-pwm.md](../11-pwm.md)
...
```swift
var pwm = LEDC.channel0(pin: GPIO5, frequency: 50)
pwm.setDutyPercent(7.5)  // ~1.5 ms pulse for servo
```

### Ownership / ARC Notes

- PWM channel owns pin alternate function.
