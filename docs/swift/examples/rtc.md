...
**Goal:** SNTP / external RTC — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/10-timers.md](../10-timers.md) if applicable.

**Protocol:** [communication/10-timers.md](../10-timers.md)
...
struct Clock {
    ...
    mutating func sync(from sntp: SNTPClient) async throws { /* ... */ }
}
```

### Ownership / ARC Notes

- If using `class` for SNTP client, hold weak delegate to avoid cycles.
