...
**Goal:** Analog voltage out — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/13-dac.md](../13-dac.md) if applicable.

**Protocol:** [communication/13-dac.md](../13-dac.md)
...
```swift
var dac = DAC.channel1()
dac.write(value: 128)  // ~mid-scale
```

### Ownership / ARC Notes

- Single channel — value type wrapper.
