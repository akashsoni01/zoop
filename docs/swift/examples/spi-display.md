...
**Goal:** ST7789 TFT — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/spi.md](../communication/spi.md) if applicable.

**Protocol:** [communication/spi.md](../communication/spi.md)
...
struct ST7789 {
    ...
    mutating func fillRect(_ r: Rect, color: RGB565) throws { /* ... */ }
}
```

### Ownership / ARC Notes

- Display driver is a struct — SPI bus borrowed mutably during draw.
