...
**Goal:** Peripheral advertising — hands-on Embedded Swift.

**Prerequisites:** See core lessons and [communication/ble.md](../communication/ble.md) if applicable.

**Protocol:** [communication/ble.md](../communication/ble.md)
...
struct ThermometerService {
    ...
    func register(on gatt: GATTServer) { /* 0x1809 */ }
}
```

### Ownership / ARC Notes

- GATT callbacks: avoid capturing self strongly in closures.
